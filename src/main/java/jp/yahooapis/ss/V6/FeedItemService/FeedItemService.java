 ...
 * 
 */
@WebServiceClient(name = "FeedItemService", targetNamespace = "http://ss.yahooapis.jp/V6", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V6.0/FeedItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FEEDITEMSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V6", "FeedItemService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V6.0/FeedItemService?wsdl");
    ...
    public FeedItemServiceInterface getFeedItemService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "FeedItemService"), FeedItemServiceInterface.class);
    }
    ...
    public FeedItemServiceInterface getFeedItemService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "FeedItemService"), FeedItemServiceInterface.class, features);
    }
