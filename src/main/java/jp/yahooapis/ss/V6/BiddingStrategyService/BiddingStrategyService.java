 ...
 * 
 */
@WebServiceClient(name = "BiddingStrategyService", targetNamespace = "http://ss.yahooapis.jp/V6", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V6.4/BiddingStrategyService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BIDDINGSTRATEGYSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V6", "BiddingStrategyService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V6.4/BiddingStrategyService?wsdl");
    ...
    public BiddingStrategyServiceInterface getBiddingStrategyService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "BiddingStrategyService"), BiddingStrategyServiceInterface.class);
    }
    ...
    public BiddingStrategyServiceInterface getBiddingStrategyService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "BiddingStrategyService"), BiddingStrategyServiceInterface.class, features);
    }
