 ...
 * generated in the jp.yahooapis.ss.V6.TargetingIdeaService package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.V6.TargetingIdeaService
     * 
     */
