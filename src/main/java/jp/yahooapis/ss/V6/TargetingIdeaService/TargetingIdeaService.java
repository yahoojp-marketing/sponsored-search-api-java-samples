 ...
 * 
 */
@WebServiceClient(name = "TargetingIdeaService", targetNamespace = "http://ss.yahooapis.jp/V6", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V6.2/TargetingIdeaService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TARGETINGIDEASERVICE_QNAME = new QName("http://ss.yahooapis.jp/V6", "TargetingIdeaService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V6.2/TargetingIdeaService?wsdl");
    ...
    public TargetingIdeaServiceInterface getTargetingIdeaService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "TargetingIdeaService"), TargetingIdeaServiceInterface.class);
    }
    ...
    public TargetingIdeaServiceInterface getTargetingIdeaService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "TargetingIdeaService"), TargetingIdeaServiceInterface.class, features);
    }
