 ...
 * 
 */
@WebServiceClient(name = "ConversionTrackerService", targetNamespace = "http://ss.yahooapis.jp/V6", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V6.3/ConversionTrackerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSIONTRACKERSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V6", "ConversionTrackerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V6.3/ConversionTrackerService?wsdl");
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "ConversionTrackerService"), ConversionTrackerServiceInterface.class);
    }
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V6", "ConversionTrackerService"), ConversionTrackerServiceInterface.class, features);
    }
