 ...
 * 
 */
@WebServiceClient(name = "SharedCriterionService", targetNamespace = "http://ss.yahooapis.jp/V6", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V6.1/SharedCriterionService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V6.1/SharedCriterionService?wsdl");
