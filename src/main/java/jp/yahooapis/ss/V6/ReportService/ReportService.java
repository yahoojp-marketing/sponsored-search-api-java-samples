 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://ss.yahooapis.jp/V6", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V6.0/ReportService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V6.0/ReportService?wsdl");
