    ...
    extends Service
{
    ...
    private final static QName BIDLANDSCAPESERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/BidLandscape", "BidLandscapeService");
    ...
    public BidLandscapeServiceInterface getBidLandscapeService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/BidLandscape", "BidLandscapeService"), BidLandscapeServiceInterface.class);
    }
    ...
    public BidLandscapeServiceInterface getBidLandscapeService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/BidLandscape", "BidLandscapeService"), BidLandscapeServiceInterface.class, features);
    }
