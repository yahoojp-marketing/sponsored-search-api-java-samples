    ...
    extends Service
{
    ...
    private final static QName DICTIONARYSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/Dictionary", "DictionaryService");
    ...
    public DictionaryServiceInterface getDictionaryService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Dictionary", "DictionaryService"), DictionaryServiceInterface.class);
    }
    ...
    public DictionaryServiceInterface getDictionaryService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Dictionary", "DictionaryService"), DictionaryServiceInterface.class, features);
    }
