    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/Account", "AccountService");
    ...
    public AccountServiceInterface getAccountService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Account", "AccountService"), AccountServiceInterface.class);
    }
    ...
    public AccountServiceInterface getAccountService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Account", "AccountService"), AccountServiceInterface.class, features);
    }
