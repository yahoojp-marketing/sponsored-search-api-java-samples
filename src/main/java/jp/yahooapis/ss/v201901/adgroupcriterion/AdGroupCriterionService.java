    ...
    extends Service
{
    ...
    private final static QName ADGROUPCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/AdGroupCriterion", "AdGroupCriterionService");
    ...
    public AdGroupCriterionServiceInterface getAdGroupCriterionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupCriterion", "AdGroupCriterionService"), AdGroupCriterionServiceInterface.class);
    }
    ...
    public AdGroupCriterionServiceInterface getAdGroupCriterionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupCriterion", "AdGroupCriterionService"), AdGroupCriterionServiceInterface.class, features);
    }
