    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/CampaignCriterion", "CampaignCriterionService");
    ...
    public CampaignCriterionServiceInterface getCampaignCriterionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/CampaignCriterion", "CampaignCriterionService"), CampaignCriterionServiceInterface.class);
    }
    ...
    public CampaignCriterionServiceInterface getCampaignCriterionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/CampaignCriterion", "CampaignCriterionService"), CampaignCriterionServiceInterface.class, features);
    }
