    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/Report", "ReportService");
    ...
    public ReportServiceInterface getReportService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Report", "ReportService"), ReportServiceInterface.class);
    }
    ...
    public ReportServiceInterface getReportService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Report", "ReportService"), ReportServiceInterface.class, features);
    }
