    ...
    extends Service
{
    ...
    private final static QName LOCATIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/Location", "LocationService");
    ...
    public LocationServiceInterface getLocationService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Location", "LocationService"), LocationServiceInterface.class);
    }
    ...
    public LocationServiceInterface getLocationService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/Location", "LocationService"), LocationServiceInterface.class, features);
    }
