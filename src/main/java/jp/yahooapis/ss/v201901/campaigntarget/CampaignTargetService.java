    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNTARGETSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/CampaignTarget", "CampaignTargetService");
    ...
    public CampaignTargetServiceInterface getCampaignTargetService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/CampaignTarget", "CampaignTargetService"), CampaignTargetServiceInterface.class);
    }
    ...
    public CampaignTargetServiceInterface getCampaignTargetService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/CampaignTarget", "CampaignTargetService"), CampaignTargetServiceInterface.class, features);
    }
