    ...
    extends Service
{
    ...
    private final static QName SHAREDCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/SharedCriterion", "SharedCriterionService");
    ...
    public SharedCriterionServiceInterface getSharedCriterionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/SharedCriterion", "SharedCriterionService"), SharedCriterionServiceInterface.class);
    }
    ...
    public SharedCriterionServiceInterface getSharedCriterionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/SharedCriterion", "SharedCriterionService"), SharedCriterionServiceInterface.class, features);
    }
