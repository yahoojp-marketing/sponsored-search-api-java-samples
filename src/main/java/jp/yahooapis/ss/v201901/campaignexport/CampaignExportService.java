    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNEXPORTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/CampaignExport", "CampaignExportService");
    ...
    public CampaignExportServiceInterface getCampaignExportService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/CampaignExport", "CampaignExportService"), CampaignExportServiceInterface.class);
    }
    ...
    public CampaignExportServiceInterface getCampaignExportService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/CampaignExport", "CampaignExportService"), CampaignExportServiceInterface.class, features);
    }
