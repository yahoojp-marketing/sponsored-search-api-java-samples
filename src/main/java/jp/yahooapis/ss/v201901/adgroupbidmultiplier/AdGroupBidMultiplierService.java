    ...
    extends Service
{
    ...
    private final static QName ADGROUPBIDMULTIPLIERSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/AdGroupBidMultiplier", "AdGroupBidMultiplierService");
    ...
    public AdGroupBidMultiplierServiceInterface getAdGroupBidMultiplierService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupBidMultiplier", "AdGroupBidMultiplierService"), AdGroupBidMultiplierServiceInterface.class);
    }
    ...
    public AdGroupBidMultiplierServiceInterface getAdGroupBidMultiplierService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupBidMultiplier", "AdGroupBidMultiplierService"), AdGroupBidMultiplierServiceInterface.class, features);
    }
