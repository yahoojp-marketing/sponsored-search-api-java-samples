    ...
    extends Service
{
    ...
    private final static QName ADGROUPFEEDSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/AdGroupFeed", "AdGroupFeedService");
    ...
    public AdGroupFeedServiceInterface getAdGroupFeedService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupFeed", "AdGroupFeedService"), AdGroupFeedServiceInterface.class);
    }
    ...
    public AdGroupFeedServiceInterface getAdGroupFeedService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupFeed", "AdGroupFeedService"), AdGroupFeedServiceInterface.class, features);
    }
