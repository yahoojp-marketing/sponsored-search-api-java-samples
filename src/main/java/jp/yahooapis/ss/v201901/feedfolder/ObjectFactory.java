 ...
 * generated in the jp.yahooapis.ss.v201901.feedfolder package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestHeader_QNAME = new QName("http://ss.yahooapis.jp/V201901/FeedFolder", "RequestHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://ss.yahooapis.jp/V201901/FeedFolder", "ApiExceptionFault");
    private final static QName _ResponseHeader_QNAME = new QName("http://ss.yahooapis.jp/V201901/FeedFolder", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.v201901.feedfolder
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201901/FeedFolder", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201901/FeedFolder", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201901/FeedFolder", name = "ResponseHeader")
