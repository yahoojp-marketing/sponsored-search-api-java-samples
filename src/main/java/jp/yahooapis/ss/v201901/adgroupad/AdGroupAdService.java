    ...
    extends Service
{
    ...
    private final static QName ADGROUPADSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/AdGroupAd", "AdGroupAdService");
    ...
    public AdGroupAdServiceInterface getAdGroupAdService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class);
    }
    ...
    public AdGroupAdServiceInterface getAdGroupAdService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class, features);
    }
