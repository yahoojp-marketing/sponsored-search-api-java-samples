    ...
    extends Service
{
    ...
    private final static QName FEEDITEMSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/FeedItem", "FeedItemService");
    ...
    public FeedItemServiceInterface getFeedItemService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/FeedItem", "FeedItemService"), FeedItemServiceInterface.class);
    }
    ...
    public FeedItemServiceInterface getFeedItemService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/FeedItem", "FeedItemService"), FeedItemServiceInterface.class, features);
    }
