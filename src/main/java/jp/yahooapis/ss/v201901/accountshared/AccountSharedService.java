    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSHAREDSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/AccountShared", "AccountSharedService");
    ...
    public AccountSharedServiceInterface getAccountSharedService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AccountShared", "AccountSharedService"), AccountSharedServiceInterface.class);
    }
    ...
    public AccountSharedServiceInterface getAccountSharedService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AccountShared", "AccountSharedService"), AccountSharedServiceInterface.class, features);
    }
