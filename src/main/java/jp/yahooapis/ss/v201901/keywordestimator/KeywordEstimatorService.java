    ...
    extends Service
{
    ...
    private final static QName KEYWORDESTIMATORSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/KeywordEstimator", "KeywordEstimatorService");
    ...
    public KeywordEstimatorServiceInterface getKeywordEstimatorService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/KeywordEstimator", "KeywordEstimatorService"), KeywordEstimatorServiceInterface.class);
    }
    ...
    public KeywordEstimatorServiceInterface getKeywordEstimatorService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/KeywordEstimator", "KeywordEstimatorService"), KeywordEstimatorServiceInterface.class, features);
    }
