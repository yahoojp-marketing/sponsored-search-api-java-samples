    ...
    extends Service
{
    ...
    private final static QName ADGROUPSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201901/AdGroup", "AdGroupService");
    ...
    public AdGroupServiceInterface getAdGroupService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroup", "AdGroupService"), AdGroupServiceInterface.class);
    }
    ...
    public AdGroupServiceInterface getAdGroupService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201901/AdGroup", "AdGroupService"), AdGroupServiceInterface.class, features);
    }
