...
import jp.yahooapis.ss.v201901.adgroupbidmultiplier.AdGroupBidMultiplierOperation;
import jp.yahooapis.ss.v201901.adgroupbidmultiplier.AdGroupBidMultiplierSelector;
...
import jp.yahooapis.ss.v201901.campaigntarget.CampaignTarget;
import jp.yahooapis.ss.v201901.campaigntarget.CampaignTargetOperation;
import jp.yahooapis.ss.v201901.campaigntarget.CampaignTargetSelector;
import jp.yahooapis.ss.v201901.campaigntarget.CampaignTargetValues;
...
public class AdSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      // =================================================================
      // ADD
      BiddingStrategyOperation addRequestBiddingStrategy = BiddingStrategyServiceSample.buildExampleMutateRequest(
          Operator.ADD,
          accountId,
      ...
      // SET
      BiddingStrategyOperation setRequestBiddingStrategy = BiddingStrategyServiceSample.buildExampleMutateRequest(
          Operator.SET,
          accountId,
      ...
      // GET
      BiddingStrategySelector getRequestBiddingStrategy = BiddingStrategyServiceSample.buildExampleGetRequest(
          accountId,
      ...
      // =================================================================
      // ADD
      CampaignTargetOperation addRequestCampaignTarget = CampaignTargetServiceSample.buildExampleMutateRequest(
          jp.yahooapis.ss.v201901.campaigntarget.Operator.ADD,
          accountId,
      ...
      // SET
      CampaignTargetOperation setRequestCampaignTarget = CampaignTargetServiceSample.buildExampleMutateRequest(
          jp.yahooapis.ss.v201901.campaigntarget.Operator.SET,
          accountId,
      ...
      // =================================================================
      // ADD
      CampaignCriterionOperation addRequestCampaignCriterion = CampaignCriterionServiceSample.buildExampleMutateRequest(
          jp.yahooapis.ss.v201901.campaigncriterion.Operator.ADD,
      ...
      // GET
      AdGroupCriterionSelector getRequestAdGroupCriterion = AdGroupCriterionServiceSample.buildExampleGetRequest(
          accountId, AdGroupCriterionUse.BIDDABLE, valuesRepositoryFacade.getAdGroupCriterionValuesRepository().getAdGroupCriterions()
      );
      ...
      // =================================================================
      // SET
      AdGroupBidMultiplierOperation setRequestAdGroupBidMultiplier = AdGroupBidMultiplierServiceSample.buildExampleMutateRequest(
          jp.yahooapis.ss.v201901.adgroupbidmultiplier.Operator.SET,
          accountId,
      ...
      CampaignFeedOperation setRequestCampaignFeed = CampaignFeedServiceSample.buildExampleMutateRequest(
          jp.yahooapis.ss.v201901.campaignfeed.Operator.SET,
          accountId,
          Arrays.asList(CampaignFeedServiceSample.createExampleSetRequest(accountId, campaignIdStandard, feedItemId, CampaignFeedPlaceholderType.QUICKLINK))
      );
      ...
      AdGroupFeedOperation setRequestAdGroupFeed = AdGroupFeedServiceSample.buildExampleMutateRequest(
          jp.yahooapis.ss.v201901.adgroupfeed.Operator.SET,
          accountId,
          Arrays.asList(AdGroupFeedServiceSample.createExampleSetRequest(accountId, campaignIdStandard, adGroupIdStandard, feedItemId, AdGroupFeedPlaceholderType.QUICKLINK))
      );
