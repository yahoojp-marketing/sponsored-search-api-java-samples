 ...
 * generated in the jp.yahooapis.ss.v201808.accounttrackingurl package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResponseHeader_QNAME = new QName("http://ss.yahooapis.jp/V201808/AccountTrackingUrl", "ResponseHeader");
    private final static QName _RequestHeader_QNAME = new QName("http://ss.yahooapis.jp/V201808/AccountTrackingUrl", "RequestHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://ss.yahooapis.jp/V201808/AccountTrackingUrl", "ApiExceptionFault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.v201808.accounttrackingurl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201808/AccountTrackingUrl", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201808/AccountTrackingUrl", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201808/AccountTrackingUrl", name = "ApiExceptionFault")
