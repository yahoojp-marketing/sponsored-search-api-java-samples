 ...
 *         &lt;element name="biddingStrategyType" type="{http://ss.yahooapis.jp/V201808/AdGroup}BiddingStrategyType" minOccurs="0"/>
 *         &lt;element name="biddingStrategySource" type="{http://ss.yahooapis.jp/V201808/AdGroup}BiddingStrategySource" minOccurs="0"/>
 *         &lt;element name="biddingScheme" type="{http://ss.yahooapis.jp/V201808/AdGroup}BiddingScheme" minOccurs="0"/>
 *         &lt;element name="initialBid" type="{http://ss.yahooapis.jp/V201808/AdGroup}Bid" minOccurs="0"/>
 *         &lt;element name="parentBiddingStrategyConfigurations" type="{http://ss.yahooapis.jp/V201808/AdGroup}AdGroupBiddingStrategy" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AdGroupBiddingStrategy {
    ...
    protected List<AdGroupBiddingStrategy> parentBiddingStrategyConfigurations;
     ...
     * 
     */
    public List<AdGroupBiddingStrategy> getParentBiddingStrategyConfigurations() {
        if (parentBiddingStrategyConfigurations == null) {
            parentBiddingStrategyConfigurations = new ArrayList<AdGroupBiddingStrategy>();
        }
