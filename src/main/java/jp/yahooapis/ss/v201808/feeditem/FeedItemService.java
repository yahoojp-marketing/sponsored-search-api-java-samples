 ...
 * 
 */
@WebServiceClient(name = "FeedItemService", targetNamespace = "http://ss.yahooapis.jp/V201808/FeedItem", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201808/FeedItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FEEDITEMSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201808/FeedItem", "FeedItemService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201808/FeedItemService?wsdl");
    ...
    public FeedItemServiceInterface getFeedItemService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/FeedItem", "FeedItemService"), FeedItemServiceInterface.class);
    }
    ...
    public FeedItemServiceInterface getFeedItemService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/FeedItem", "FeedItemService"), FeedItemServiceInterface.class, features);
    }
