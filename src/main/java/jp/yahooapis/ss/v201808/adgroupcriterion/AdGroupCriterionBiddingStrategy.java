...
/**
 * <p>Java class for AdGroupCriterionBiddingStrategy complex type.
 * 
 ...
 *         &lt;element name="biddingStrategyType" type="{http://ss.yahooapis.jp/V201808/AdGroupCriterion}BiddingStrategyType" minOccurs="0"/>
 *         &lt;element name="biddingStrategySource" type="{http://ss.yahooapis.jp/V201808/AdGroupCriterion}BiddingStrategySource" minOccurs="0"/>
 *         &lt;element name="biddingScheme" type="{http://ss.yahooapis.jp/V201808/AdGroupCriterion}BiddingScheme" minOccurs="0"/>
 *         &lt;element name="bid" type="{http://ss.yahooapis.jp/V201808/AdGroupCriterion}Bid" minOccurs="0"/>
 *         &lt;element name="parentBiddingStrategyConfigurations" type="{http://ss.yahooapis.jp/V201808/AdGroupCriterion}AdGroupCriterionBiddingStrategy" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AdGroupCriterionBiddingStrategy", propOrder = {
    "biddingStrategyId",
    "biddingStrategyName",
    "biddingStrategyType",
...
public class AdGroupCriterionBiddingStrategy {
    ...
    protected Bid bid;
    protected List<AdGroupCriterionBiddingStrategy> parentBiddingStrategyConfigurations;
     ...
     * 
     */
    public List<AdGroupCriterionBiddingStrategy> getParentBiddingStrategyConfigurations() {
        if (parentBiddingStrategyConfigurations == null) {
            parentBiddingStrategyConfigurations = new ArrayList<AdGroupCriterionBiddingStrategy>();
        }
