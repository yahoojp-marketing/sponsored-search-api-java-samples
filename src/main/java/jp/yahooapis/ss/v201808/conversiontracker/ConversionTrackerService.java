 ...
 * 
 */
@WebServiceClient(name = "ConversionTrackerService", targetNamespace = "http://ss.yahooapis.jp/V201808/ConversionTracker", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201808/ConversionTrackerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSIONTRACKERSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201808/ConversionTracker", "ConversionTrackerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201808/ConversionTrackerService?wsdl");
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/ConversionTracker", "ConversionTrackerService"), ConversionTrackerServiceInterface.class);
    }
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/ConversionTracker", "ConversionTrackerService"), ConversionTrackerServiceInterface.class, features);
    }
