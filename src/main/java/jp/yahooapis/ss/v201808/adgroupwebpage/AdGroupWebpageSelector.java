...
/**
 * <p>Java class for AdGroupWebpageSelector complex type.
 * 
 ...
 *         &lt;element name="targetIds" type="{http://www.w3.org/2001/XMLSchema}long" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "AdGroupWebpageSelector", propOrder = {
    "accountId",
    "campaignIds",
    "adGroupIds",
    "targetIds",
...
public class AdGroupWebpageSelector {
