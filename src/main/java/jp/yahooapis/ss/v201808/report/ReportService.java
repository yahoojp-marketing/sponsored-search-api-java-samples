 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://ss.yahooapis.jp/V201808/Report", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201808/ReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201808/Report", "ReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201808/ReportService?wsdl");
    ...
    public ReportServiceInterface getReportService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/Report", "ReportService"), ReportServiceInterface.class);
    }
    ...
    public ReportServiceInterface getReportService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/Report", "ReportService"), ReportServiceInterface.class, features);
    }
