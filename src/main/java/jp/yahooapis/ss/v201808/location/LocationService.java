 ...
 * 
 */
@WebServiceClient(name = "LocationService", targetNamespace = "http://ss.yahooapis.jp/V201808/Location", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201808/LocationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOCATIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201808/Location", "LocationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201808/LocationService?wsdl");
    ...
    public LocationServiceInterface getLocationService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/Location", "LocationService"), LocationServiceInterface.class);
    }
    ...
    public LocationServiceInterface getLocationService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/Location", "LocationService"), LocationServiceInterface.class, features);
    }
