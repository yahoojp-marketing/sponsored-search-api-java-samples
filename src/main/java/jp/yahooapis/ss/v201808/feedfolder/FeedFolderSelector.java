...
/**
 * <p>Java class for FeedFolderSelector complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FeedFolderSelector">
 *   &lt;complexContent>
 ...
 *         &lt;element name="placeholderTypes" type="{http://ss.yahooapis.jp/V201808/FeedFolder}FeedFolderPlaceholderType" maxOccurs="2" minOccurs="0"/>
...
@XmlType(name = "FeedFolderSelector", propOrder = {
    "accountId",
    "feedFolderIds",
    "placeholderTypes",
    "paging"
})
public class FeedFolderSelector {

    protected long accountId;
    @XmlElement(type = Long.class)
    protected List<Long> feedFolderIds;
    @XmlSchemaType(name = "string")
    protected List<FeedFolderPlaceholderType> placeholderTypes;
     ...
     * 
     */
    public List<FeedFolderPlaceholderType> getPlaceholderTypes() {
        if (placeholderTypes == null) {
            placeholderTypes = new ArrayList<FeedFolderPlaceholderType>();
        }
