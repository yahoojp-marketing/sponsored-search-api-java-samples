 ...
 * generated in the jp.yahooapis.ss.v201808.auditlog package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestHeader_QNAME = new QName("http://ss.yahooapis.jp/V201808/AuditLog", "RequestHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://ss.yahooapis.jp/V201808/AuditLog", "ApiExceptionFault");
    private final static QName _ResponseHeader_QNAME = new QName("http://ss.yahooapis.jp/V201808/AuditLog", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.v201808.auditlog
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201808/AuditLog", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201808/AuditLog", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201808/AuditLog", name = "ResponseHeader")
