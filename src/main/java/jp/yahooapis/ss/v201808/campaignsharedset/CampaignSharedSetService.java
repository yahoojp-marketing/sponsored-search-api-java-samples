 ...
 * 
 */
@WebServiceClient(name = "CampaignSharedSetService", targetNamespace = "http://ss.yahooapis.jp/V201808/CampaignSharedSet", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201808/CampaignSharedSetService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNSHAREDSETSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201808/CampaignSharedSet", "CampaignSharedSetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201808/CampaignSharedSetService?wsdl");
    ...
    public CampaignSharedSetServiceInterface getCampaignSharedSetService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/CampaignSharedSet", "CampaignSharedSetService"), CampaignSharedSetServiceInterface.class);
    }
    ...
    public CampaignSharedSetServiceInterface getCampaignSharedSetService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201808/CampaignSharedSet", "CampaignSharedSetService"), CampaignSharedSetServiceInterface.class, features);
    }
