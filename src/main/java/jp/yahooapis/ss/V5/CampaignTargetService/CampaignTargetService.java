 ...
 * 
 */
@WebServiceClient(name = "CampaignTargetService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.2/CampaignTargetService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNTARGETSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V5", "CampaignTargetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.2/CampaignTargetService?wsdl");
