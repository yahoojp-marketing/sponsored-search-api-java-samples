 ...
 * 
 */
@WebServiceClient(name = "BiddingStrategyService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.3/BiddingStrategyService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.3/BiddingStrategyService?wsdl");
