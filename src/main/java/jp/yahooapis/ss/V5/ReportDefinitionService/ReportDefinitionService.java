 ...
 * 
 */
@WebServiceClient(name = "ReportDefinitionService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.2/ReportDefinitionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTDEFINITIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V5", "ReportDefinitionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.2/ReportDefinitionService?wsdl");
