 ...
 * 
 */
@WebServiceClient(name = "AdGroupAdService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.3/AdGroupAdService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPADSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V5", "AdGroupAdService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.3/AdGroupAdService?wsdl");
