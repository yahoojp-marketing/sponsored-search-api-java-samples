 ...
 * 
 */
@WebServiceClient(name = "KeywordEstimatorService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.2/KeywordEstimatorService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.2/KeywordEstimatorService?wsdl");
