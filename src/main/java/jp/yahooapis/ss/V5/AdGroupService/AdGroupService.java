 ...
 * 
 */
@WebServiceClient(name = "AdGroupService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.2/AdGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V5", "AdGroupService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.2/AdGroupService?wsdl");
