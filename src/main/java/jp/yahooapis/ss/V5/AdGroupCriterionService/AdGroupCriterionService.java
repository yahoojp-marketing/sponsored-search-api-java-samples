 ...
 * 
 */
@WebServiceClient(name = "AdGroupCriterionService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.3/AdGroupCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V5", "AdGroupCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.3/AdGroupCriterionService?wsdl");
