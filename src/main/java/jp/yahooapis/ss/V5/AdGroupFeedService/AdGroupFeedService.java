 ...
 * 
 */
@WebServiceClient(name = "AdGroupFeedService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.3/AdGroupFeedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPFEEDSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V5", "AdGroupFeedService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.3/AdGroupFeedService?wsdl");
