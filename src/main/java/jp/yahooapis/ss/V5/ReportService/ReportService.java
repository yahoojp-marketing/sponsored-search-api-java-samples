 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.3/ReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V5", "ReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V5.3/ReportService?wsdl");
