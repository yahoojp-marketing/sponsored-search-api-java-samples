 ...
 * 
 */
@WebServiceClient(name = "AdGroupCriterionLabelService", targetNamespace = "http://ss.yahooapis.jp/V201909/AdGroupCriterionLabel", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupCriterionLabelService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPCRITERIONLABELSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/AdGroupCriterionLabel", "AdGroupCriterionLabelService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupCriterionLabelService?wsdl");
    ...
    public AdGroupCriterionLabelServiceInterface getAdGroupCriterionLabelService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupCriterionLabel", "AdGroupCriterionLabelService"), AdGroupCriterionLabelServiceInterface.class);
    }
    ...
    public AdGroupCriterionLabelServiceInterface getAdGroupCriterionLabelService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupCriterionLabel", "AdGroupCriterionLabelService"), AdGroupCriterionLabelServiceInterface.class, features);
    }
