 ...
 * 
 */
@WebServiceClient(name = "CampaignCriterionService", targetNamespace = "http://ss.yahooapis.jp/V201909/CampaignCriterion", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/CampaignCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/CampaignCriterion", "CampaignCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/CampaignCriterionService?wsdl");
    ...
    public CampaignCriterionServiceInterface getCampaignCriterionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/CampaignCriterion", "CampaignCriterionService"), CampaignCriterionServiceInterface.class);
    }
    ...
    public CampaignCriterionServiceInterface getCampaignCriterionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/CampaignCriterion", "CampaignCriterionService"), CampaignCriterionServiceInterface.class, features);
    }
