 ...
 * 
 */
@WebServiceClient(name = "CampaignService", targetNamespace = "http://ss.yahooapis.jp/V201909/Campaign", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/CampaignService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/Campaign", "CampaignService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/CampaignService?wsdl");
    ...
    public CampaignServiceInterface getCampaignService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/Campaign", "CampaignService"), CampaignServiceInterface.class);
    }
    ...
    public CampaignServiceInterface getCampaignService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/Campaign", "CampaignService"), CampaignServiceInterface.class, features);
    }
