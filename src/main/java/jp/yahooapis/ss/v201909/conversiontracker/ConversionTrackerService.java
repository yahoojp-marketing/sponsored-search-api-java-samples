 ...
 * 
 */
@WebServiceClient(name = "ConversionTrackerService", targetNamespace = "http://ss.yahooapis.jp/V201909/ConversionTracker", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/ConversionTrackerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSIONTRACKERSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/ConversionTracker", "ConversionTrackerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/ConversionTrackerService?wsdl");
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/ConversionTracker", "ConversionTrackerService"), ConversionTrackerServiceInterface.class);
    }
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/ConversionTracker", "ConversionTrackerService"), ConversionTrackerServiceInterface.class, features);
    }
