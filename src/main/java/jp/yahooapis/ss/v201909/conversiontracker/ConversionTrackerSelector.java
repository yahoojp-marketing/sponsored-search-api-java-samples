 ...
 *         &lt;element name="statuses" type="{http://ss.yahooapis.jp/V201909/ConversionTracker}ConversionTrackerStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="categories" type="{http://ss.yahooapis.jp/V201909/ConversionTracker}ConversionTrackerCategory" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="conversionTrackerTypes" type="{http://ss.yahooapis.jp/V201909/ConversionTracker}ConversionTrackerType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="trackingCodeTypes" type="{http://ss.yahooapis.jp/V201909/ConversionTracker}TrackingCodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="countingTypes" type="{http://ss.yahooapis.jp/V201909/ConversionTracker}ConversionCountingType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="excludeFromBiddings" type="{http://ss.yahooapis.jp/V201909/ConversionTracker}ExcludeFromBidding" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="dateRange" type="{http://ss.yahooapis.jp/V201909/ConversionTracker}ConversionDateRange" minOccurs="0"/>
