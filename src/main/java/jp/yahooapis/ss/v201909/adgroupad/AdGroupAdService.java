 ...
 * 
 */
@WebServiceClient(name = "AdGroupAdService", targetNamespace = "http://ss.yahooapis.jp/V201909/AdGroupAd", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupAdService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPADSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/AdGroupAd", "AdGroupAdService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupAdService?wsdl");
    ...
    public AdGroupAdServiceInterface getAdGroupAdService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class);
    }
    ...
    public AdGroupAdServiceInterface getAdGroupAdService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class, features);
    }
