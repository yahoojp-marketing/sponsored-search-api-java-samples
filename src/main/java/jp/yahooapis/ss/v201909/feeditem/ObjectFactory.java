 ...
 * generated in the jp.yahooapis.ss.v201909.feeditem package. 
...
public class ObjectFactory {
    ...
    private final static QName _ApiExceptionFault_QNAME = new QName("http://ss.yahooapis.jp/V201909/FeedItem", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://ss.yahooapis.jp/V201909/FeedItem", "RequestHeader");
    private final static QName _ResponseHeader_QNAME = new QName("http://ss.yahooapis.jp/V201909/FeedItem", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.v201909.feeditem
     * 
     */
    ...
    /**
     * Create an instance of {@link FeedItemSetTrademarkStatusOperation }
     * 
     */
    public FeedItemSetTrademarkStatusOperation createFeedItemSetTrademarkStatusOperation() {
        return new FeedItemSetTrademarkStatusOperation();
    }
    ...
    /**
     * Create an instance of {@link FeedItemSetTrademarkStatus }
     * 
     */
    public FeedItemSetTrademarkStatus createFeedItemSetTrademarkStatus() {
        return new FeedItemSetTrademarkStatus();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201909/FeedItem", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201909/FeedItem", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201909/FeedItem", name = "ResponseHeader")
