 ...
 * 
 */
@WebServiceClient(name = "AdGroupBidMultiplierService", targetNamespace = "http://ss.yahooapis.jp/V201909/AdGroupBidMultiplier", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupBidMultiplierService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPBIDMULTIPLIERSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/AdGroupBidMultiplier", "AdGroupBidMultiplierService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupBidMultiplierService?wsdl");
    ...
    public AdGroupBidMultiplierServiceInterface getAdGroupBidMultiplierService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupBidMultiplier", "AdGroupBidMultiplierService"), AdGroupBidMultiplierServiceInterface.class);
    }
    ...
    public AdGroupBidMultiplierServiceInterface getAdGroupBidMultiplierService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupBidMultiplier", "AdGroupBidMultiplierService"), AdGroupBidMultiplierServiceInterface.class, features);
    }
