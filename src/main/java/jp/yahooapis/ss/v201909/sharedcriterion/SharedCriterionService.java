 ...
 * 
 */
@WebServiceClient(name = "SharedCriterionService", targetNamespace = "http://ss.yahooapis.jp/V201909/SharedCriterion", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/SharedCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SHAREDCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/SharedCriterion", "SharedCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/SharedCriterionService?wsdl");
    ...
    public SharedCriterionServiceInterface getSharedCriterionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/SharedCriterion", "SharedCriterionService"), SharedCriterionServiceInterface.class);
    }
    ...
    public SharedCriterionServiceInterface getSharedCriterionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/SharedCriterion", "SharedCriterionService"), SharedCriterionServiceInterface.class, features);
    }
