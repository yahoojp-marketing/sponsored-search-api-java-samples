 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://ss.yahooapis.jp/V201909/Account", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/AccountService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/Account", "AccountService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/AccountService?wsdl");
    ...
    public AccountServiceInterface getAccountService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/Account", "AccountService"), AccountServiceInterface.class);
    }
    ...
    public AccountServiceInterface getAccountService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/Account", "AccountService"), AccountServiceInterface.class, features);
    }
