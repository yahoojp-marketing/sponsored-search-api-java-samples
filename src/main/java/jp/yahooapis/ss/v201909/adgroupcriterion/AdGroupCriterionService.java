 ...
 * 
 */
@WebServiceClient(name = "AdGroupCriterionService", targetNamespace = "http://ss.yahooapis.jp/V201909/AdGroupCriterion", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/AdGroupCriterion", "AdGroupCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/AdGroupCriterionService?wsdl");
    ...
    public AdGroupCriterionServiceInterface getAdGroupCriterionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupCriterion", "AdGroupCriterionService"), AdGroupCriterionServiceInterface.class);
    }
    ...
    public AdGroupCriterionServiceInterface getAdGroupCriterionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AdGroupCriterion", "AdGroupCriterionService"), AdGroupCriterionServiceInterface.class, features);
    }
