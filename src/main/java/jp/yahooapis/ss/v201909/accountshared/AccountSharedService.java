 ...
 * 
 */
@WebServiceClient(name = "AccountSharedService", targetNamespace = "http://ss.yahooapis.jp/V201909/AccountShared", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/AccountSharedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSHAREDSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/AccountShared", "AccountSharedService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/AccountSharedService?wsdl");
    ...
    public AccountSharedServiceInterface getAccountSharedService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AccountShared", "AccountSharedService"), AccountSharedServiceInterface.class);
    }
    ...
    public AccountSharedServiceInterface getAccountSharedService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AccountShared", "AccountSharedService"), AccountSharedServiceInterface.class, features);
    }
