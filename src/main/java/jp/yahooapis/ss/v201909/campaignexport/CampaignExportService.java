 ...
 * 
 */
@WebServiceClient(name = "CampaignExportService", targetNamespace = "http://ss.yahooapis.jp/V201909/CampaignExport", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/CampaignExportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNEXPORTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/CampaignExport", "CampaignExportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/CampaignExportService?wsdl");
    ...
    public CampaignExportServiceInterface getCampaignExportService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/CampaignExport", "CampaignExportService"), CampaignExportServiceInterface.class);
    }
    ...
    public CampaignExportServiceInterface getCampaignExportService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/CampaignExport", "CampaignExportService"), CampaignExportServiceInterface.class, features);
    }
