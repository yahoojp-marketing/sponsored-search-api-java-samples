 ...
 * 
 */
@WebServiceClient(name = "AccountTrackingUrlService", targetNamespace = "http://ss.yahooapis.jp/V201909/AccountTrackingUrl", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201909/AccountTrackingURLService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTTRACKINGURLSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201909/AccountTrackingUrl", "AccountTrackingUrlService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201909/AccountTrackingURLService?wsdl");
    ...
    public AccountTrackingUrlServiceInterface getAccountTrackingUrlService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AccountTrackingUrl", "AccountTrackingUrlService"), AccountTrackingUrlServiceInterface.class);
    }
    ...
    public AccountTrackingUrlServiceInterface getAccountTrackingUrlService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201909/AccountTrackingUrl", "AccountTrackingUrlService"), AccountTrackingUrlServiceInterface.class, features);
    }
