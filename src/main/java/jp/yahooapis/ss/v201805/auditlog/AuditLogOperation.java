 ...
 *         &lt;element name="operand" type="{http://ss.yahooapis.jp/V201805/AuditLog}AuditLogJob" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AuditLogOperation {
    ...
    protected List<AuditLogJob> operand;
     ...
     * 
     */
    public List<AuditLogJob> getOperand() {
        if (operand == null) {
            operand = new ArrayList<AuditLogJob>();
        }
        return this.operand;
    }
