 ...
 *         &lt;element name="statuses" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}ConversionTrackerStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="categories" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}ConversionTrackerCategory" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="conversionTrackerTypes" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}ConversionTrackerType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="trackingCodeTypes" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}TrackingCodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="countingTypes" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}ConversionCountingType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="excludeFromBiddings" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}ExcludeFromBidding" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="crossDeviceConversionFlags" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}CrossDeviceConversionFlag" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="dateRange" type="{http://ss.yahooapis.jp/V201805/ConversionTracker}ConversionDateRange" minOccurs="0"/>
 *         &lt;element name="paging" type="{http://ss.yahooapis.jp/V201805}Paging" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
