 ...
 * 
 */
@WebServiceClient(name = "BidLandscapeService", targetNamespace = "http://ss.yahooapis.jp/V201805/BidLandscape", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/BidLandscapeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BIDLANDSCAPESERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/BidLandscape", "BidLandscapeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/BidLandscapeService?wsdl");
    ...
    public BidLandscapeServiceInterface getBidLandscapeService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/BidLandscape", "BidLandscapeService"), BidLandscapeServiceInterface.class);
    }
    ...
    public BidLandscapeServiceInterface getBidLandscapeService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/BidLandscape", "BidLandscapeService"), BidLandscapeServiceInterface.class, features);
    }
