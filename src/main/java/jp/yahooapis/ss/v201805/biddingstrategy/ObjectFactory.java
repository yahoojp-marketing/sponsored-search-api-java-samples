 ...
 * generated in the jp.yahooapis.ss.v201805.biddingstrategy package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResponseHeader_QNAME = new QName("http://ss.yahooapis.jp/V201805/BiddingStrategy", "ResponseHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://ss.yahooapis.jp/V201805/BiddingStrategy", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://ss.yahooapis.jp/V201805/BiddingStrategy", "RequestHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.v201805.biddingstrategy
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/BiddingStrategy", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/BiddingStrategy", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/BiddingStrategy", name = "RequestHeader")
