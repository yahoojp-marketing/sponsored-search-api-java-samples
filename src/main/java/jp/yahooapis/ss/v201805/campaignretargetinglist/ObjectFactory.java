...
package jp.yahooapis.ss.v201805.campaignretargetinglist;
 ...
 * generated in the jp.yahooapis.ss.v201805.campaignretargetinglist package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResponseHeader_QNAME = new QName("http://ss.yahooapis.jp/V201805/CampaignRetargetingList", "ResponseHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://ss.yahooapis.jp/V201805/CampaignRetargetingList", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://ss.yahooapis.jp/V201805/CampaignRetargetingList", "RequestHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.v201805.campaignretargetinglist
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/CampaignRetargetingList", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/CampaignRetargetingList", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/CampaignRetargetingList", name = "RequestHeader")
