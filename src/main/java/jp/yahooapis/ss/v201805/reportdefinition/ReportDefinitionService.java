 ...
 * 
 */
@WebServiceClient(name = "ReportDefinitionService", targetNamespace = "http://ss.yahooapis.jp/V201805/ReportDefinition", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/ReportDefinitionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTDEFINITIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/ReportDefinition", "ReportDefinitionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/ReportDefinitionService?wsdl");
    ...
    public ReportDefinitionServiceInterface getReportDefinitionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/ReportDefinition", "ReportDefinitionService"), ReportDefinitionServiceInterface.class);
    }
    ...
    public ReportDefinitionServiceInterface getReportDefinitionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/ReportDefinition", "ReportDefinitionService"), ReportDefinitionServiceInterface.class, features);
    }
