 ...
 * 
 */
@WebServiceClient(name = "AdGroupService", targetNamespace = "http://ss.yahooapis.jp/V201805/AdGroup", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/AdGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/AdGroup", "AdGroupService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/AdGroupService?wsdl");
    ...
    public AdGroupServiceInterface getAdGroupService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/AdGroup", "AdGroupService"), AdGroupServiceInterface.class);
    }
    ...
    public AdGroupServiceInterface getAdGroupService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/AdGroup", "AdGroupService"), AdGroupServiceInterface.class, features);
    }
