 ...
 * 
 */
@WebServiceClient(name = "CampaignSharedSetService", targetNamespace = "http://ss.yahooapis.jp/V201805/CampaignSharedSet", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/CampaignSharedSetService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNSHAREDSETSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/CampaignSharedSet", "CampaignSharedSetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/CampaignSharedSetService?wsdl");
    ...
    public CampaignSharedSetServiceInterface getCampaignSharedSetService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/CampaignSharedSet", "CampaignSharedSetService"), CampaignSharedSetServiceInterface.class);
    }
    ...
    public CampaignSharedSetServiceInterface getCampaignSharedSetService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/CampaignSharedSet", "CampaignSharedSetService"), CampaignSharedSetServiceInterface.class, features);
    }
