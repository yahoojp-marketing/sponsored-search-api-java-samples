 ...
 * 
 */
@WebServiceClient(name = "TargetingIdeaService", targetNamespace = "http://ss.yahooapis.jp/V201805/TargetingIdea", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/TargetingIdeaService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TARGETINGIDEASERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/TargetingIdea", "TargetingIdeaService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/TargetingIdeaService?wsdl");
    ...
    public TargetingIdeaServiceInterface getTargetingIdeaService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/TargetingIdea", "TargetingIdeaService"), TargetingIdeaServiceInterface.class);
    }
    ...
    public TargetingIdeaServiceInterface getTargetingIdeaService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/TargetingIdea", "TargetingIdeaService"), TargetingIdeaServiceInterface.class, features);
    }
