 ...
 * 
 */
@WebServiceClient(name = "KeywordEstimatorService", targetNamespace = "http://ss.yahooapis.jp/V201805/KeywordEstimator", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/KeywordEstimatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName KEYWORDESTIMATORSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/KeywordEstimator", "KeywordEstimatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/KeywordEstimatorService?wsdl");
    ...
    public KeywordEstimatorServiceInterface getKeywordEstimatorService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/KeywordEstimator", "KeywordEstimatorService"), KeywordEstimatorServiceInterface.class);
    }
    ...
    public KeywordEstimatorServiceInterface getKeywordEstimatorService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/KeywordEstimator", "KeywordEstimatorService"), KeywordEstimatorServiceInterface.class, features);
    }
