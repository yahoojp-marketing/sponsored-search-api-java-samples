 ...
 * 
 */
@WebServiceClient(name = "CampaignTargetService", targetNamespace = "http://ss.yahooapis.jp/V201805/CampaignTarget", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/CampaignTargetService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNTARGETSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/CampaignTarget", "CampaignTargetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/CampaignTargetService?wsdl");
    ...
    public CampaignTargetServiceInterface getCampaignTargetService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/CampaignTarget", "CampaignTargetService"), CampaignTargetServiceInterface.class);
    }
    ...
    public CampaignTargetServiceInterface getCampaignTargetService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/CampaignTarget", "CampaignTargetService"), CampaignTargetServiceInterface.class, features);
    }
