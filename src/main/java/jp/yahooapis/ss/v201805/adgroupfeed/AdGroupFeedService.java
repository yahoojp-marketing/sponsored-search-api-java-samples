 ...
 * 
 */
@WebServiceClient(name = "AdGroupFeedService", targetNamespace = "http://ss.yahooapis.jp/V201805/AdGroupFeed", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/AdGroupFeedService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPFEEDSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/AdGroupFeed", "AdGroupFeedService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/AdGroupFeedService?wsdl");
    ...
    public AdGroupFeedServiceInterface getAdGroupFeedService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/AdGroupFeed", "AdGroupFeedService"), AdGroupFeedServiceInterface.class);
    }
    ...
    public AdGroupFeedServiceInterface getAdGroupFeedService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/AdGroupFeed", "AdGroupFeedService"), AdGroupFeedServiceInterface.class, features);
    }
