 ...
 * 
 */
@WebServiceClient(name = "SharedCriterionService", targetNamespace = "http://ss.yahooapis.jp/V201805/SharedCriterion", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/SharedCriterionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SHAREDCRITERIONSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/SharedCriterion", "SharedCriterionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/SharedCriterionService?wsdl");
    ...
    public SharedCriterionServiceInterface getSharedCriterionService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/SharedCriterion", "SharedCriterionService"), SharedCriterionServiceInterface.class);
    }
    ...
    public SharedCriterionServiceInterface getSharedCriterionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/SharedCriterion", "SharedCriterionService"), SharedCriterionServiceInterface.class, features);
    }
