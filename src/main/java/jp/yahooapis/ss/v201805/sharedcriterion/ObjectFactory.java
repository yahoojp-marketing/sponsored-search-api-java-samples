...
package jp.yahooapis.ss.v201805.sharedcriterion;
 ...
 * generated in the jp.yahooapis.ss.v201805.sharedcriterion package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResponseHeader_QNAME = new QName("http://ss.yahooapis.jp/V201805/SharedCriterion", "ResponseHeader");
    private final static QName _RequestHeader_QNAME = new QName("http://ss.yahooapis.jp/V201805/SharedCriterion", "RequestHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://ss.yahooapis.jp/V201805/SharedCriterion", "ApiExceptionFault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.ss.v201805.sharedcriterion
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/SharedCriterion", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/SharedCriterion", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ss.yahooapis.jp/V201805/SharedCriterion", name = "ApiExceptionFault")
