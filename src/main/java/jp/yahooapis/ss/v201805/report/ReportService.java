 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://ss.yahooapis.jp/V201805/Report", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/ReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/Report", "ReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/ReportService?wsdl");
    ...
    public ReportServiceInterface getReportService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/Report", "ReportService"), ReportServiceInterface.class);
    }
    ...
    public ReportServiceInterface getReportService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/Report", "ReportService"), ReportServiceInterface.class, features);
    }
