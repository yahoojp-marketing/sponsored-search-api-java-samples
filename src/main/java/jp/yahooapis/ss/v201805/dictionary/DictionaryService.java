 ...
 * 
 */
@WebServiceClient(name = "DictionaryService", targetNamespace = "http://ss.yahooapis.jp/V201805/Dictionary", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V201805/DictionaryService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DICTIONARYSERVICE_QNAME = new QName("http://ss.yahooapis.jp/V201805/Dictionary", "DictionaryService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.ss.yahooapis.jp/services/V201805/DictionaryService?wsdl");
    ...
    public DictionaryServiceInterface getDictionaryService() {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/Dictionary", "DictionaryService"), DictionaryServiceInterface.class);
    }
    ...
    public DictionaryServiceInterface getDictionaryService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ss.yahooapis.jp/V201805/Dictionary", "DictionaryService"), DictionaryServiceInterface.class, features);
    }
