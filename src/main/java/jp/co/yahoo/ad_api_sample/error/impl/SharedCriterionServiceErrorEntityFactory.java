...
import jp.yahooapis.ss.V6.SharedCriterionService.ErrorDetail;

import java.util.ArrayList;
import java.util.List;

public class SharedCriterionServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public SharedCriterionServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
