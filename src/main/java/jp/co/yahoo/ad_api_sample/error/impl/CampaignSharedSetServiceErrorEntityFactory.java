...
import jp.yahooapis.ss.V6.CampaignSharedSetService.ErrorDetail;

import java.util.ArrayList;
import java.util.List;

public class CampaignSharedSetServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public CampaignSharedSetServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
