...
import jp.yahooapis.ss.V6.CampaignRetargetingListService.ErrorDetail;

public class CampaignRetargetingListServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public CampaignRetargetingListServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
