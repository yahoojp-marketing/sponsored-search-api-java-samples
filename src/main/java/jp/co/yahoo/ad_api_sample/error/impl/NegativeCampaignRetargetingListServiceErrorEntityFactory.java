...
import jp.yahooapis.ss.V6.NegativeCampaignRetargetingListService.ErrorDetail;

public class NegativeCampaignRetargetingListServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public NegativeCampaignRetargetingListServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
