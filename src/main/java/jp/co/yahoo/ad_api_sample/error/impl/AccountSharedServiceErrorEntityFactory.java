...
import jp.yahooapis.ss.V6.AccountSharedService.ErrorDetail;

import java.util.ArrayList;
import java.util.List;

public class AccountSharedServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public AccountSharedServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
