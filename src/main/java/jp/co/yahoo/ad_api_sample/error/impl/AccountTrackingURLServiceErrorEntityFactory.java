...
import jp.yahooapis.ss.V6.AccountTrackingURLService.ErrorDetail;

public class AccountTrackingURLServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public AccountTrackingURLServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
