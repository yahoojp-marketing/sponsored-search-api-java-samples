...
import jp.yahooapis.ss.V6.AuditLogService.AuditLogJobStatus;
import jp.yahooapis.ss.V6.AuditLogService.AuditLogOperation;
import jp.yahooapis.ss.V6.AuditLogService.AuditLogPage;
import jp.yahooapis.ss.V6.AuditLogService.AuditLogReturnValue;
import jp.yahooapis.ss.V6.AuditLogService.AuditLogSelector;
import jp.yahooapis.ss.V6.AuditLogService.AuditLogService;
import jp.yahooapis.ss.V6.AuditLogService.AuditLogServiceInterface;
import jp.yahooapis.ss.V6.AuditLogService.AuditLogValues;
import jp.yahooapis.ss.V6.AuditLogService.DateRange;
import jp.yahooapis.ss.V6.AuditLogService.Error;
