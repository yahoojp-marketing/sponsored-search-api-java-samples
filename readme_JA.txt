...
2014/06/13:
- Version 5.1.0に対応しました。

2013/12/15:
- Version 5.0.0に対応しました。

2013/08/28:
- Version 4.2.0追加API：AdGroupBidMultiplierServiceに対応しました。
- Soap APIライブラリをJAX-WSに変更しました。

2013/07/22:
- Version 4.2.0に対応しました。Version 4.0.0からの変更点は以下になります。
